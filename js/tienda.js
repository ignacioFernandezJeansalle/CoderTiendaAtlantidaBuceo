...
const getDBProductosJSON = async () => {
  ...
  data.forEach((x) =>
    productos.push(new Producto(x.id, x.marca, x.modelo, x.clasif, x.imgFile, x.alt, x.precio, x.stock))
  );
};
...
const filtrarProductos = () => {
  if (
    !checkAletas.checked &&
    !checkChalecos.checked &&
    !checkComputadoras.checked &&
    !checkMascaras.checked &&
    !checkNeoprene.checked &&
    !checkReguladores.checked &&
    !checkSnorkels.checked
  ) {
